...
import com.example.busticketprojectkotlin.BuildConfig
import com.example.busticketprojectkotlin.services.city_search_api.ICitySearchApi
import com.example.busticketprojectkotlin.util.Constants.BASE_URL
...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideApiFactory(retrofit: Retrofit): ICitySearchApi {
        return retrofit.create(ICitySearchApi::class.java)
    }
}